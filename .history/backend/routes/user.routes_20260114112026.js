...
import { register, login, uploadProfilePicture, userUpdate, getUserAndProfile, updateProfileData, getAllUsers, downloadUserProfile, sendConnectionRequest } from "../controllers/user.controller.js";
...
router.route("/get_my_connections_request").post(getMyConnectionsRequest);
