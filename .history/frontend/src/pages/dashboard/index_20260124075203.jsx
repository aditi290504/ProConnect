...
import { createPost, getAllPosts } from "@/config/redux/action/postAction/index.js";
      ...
      <DashboardLayout>
        <div className={styles.scrollComponent}>
          <div className={styles.createPostContainer}>
            <textarea onChange={(e) => setPostContenst(e.target.value)} value={postContent} name="" id="" className={styles.textAreaOfContent} placeholder="What`s in Your Mind?"></textarea>
            ...
            {postContent.length > 0 && <div onClick={} className={styles.uploadButton}>Post</div>}
