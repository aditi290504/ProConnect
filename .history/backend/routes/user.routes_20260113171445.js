...
import { register, login, uploadProfilePicture, userUpdate, getUserAndProfile, updateProfileData, getAllUsers } from "../controllers/user.controller.js";
...
router.route("user/download_resume").get(down)
