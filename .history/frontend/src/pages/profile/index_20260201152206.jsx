          ...
          )}
        {
          ...
          <div onClick={() => {
            ...
            <div onClick={(e) => {
              ...
              <input onChange={handleWorkInputChange} name="school"  type="text" className={Styles.inputField} placeholder='Enter School' />
              <input onChange={handleWorkInputChange} name="degree" type="text" className={Styles.inputField} placeholder='Enter Degree' />
              <input onChange={handleWorkInputChange} name="fieldOfStudy" type="text" className={Styles.inputField} placeholder='Enter Field of Study' />
              <div onClick={()=>{
                setUserProfile({...userProfile, education: [...userProfile.education, inputData]})
                setIsEditing(false)
              }} className={Styles.connectButton} >Add Education </div>
