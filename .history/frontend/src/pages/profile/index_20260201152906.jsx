      ...
      <DashboardLayout>
        ...
        )}
        {
          ...
          <div onClick={() => {
            ...
            <div onClick={(e) => {
              ...
              <input onChange={handleWorkInputChange} name="company"  type="text" className={Styles.inputField} placeholder='Enter Company' />
              <input onChange={handleWorkInputChange} name="position" type="text" className={Styles.inputField} placeholder='Enter position' />
              <input onChange={handleWorkInputChange} name="years" type="number" className={Styles.inputField} placeholder='years' />
              <div onClick={()=>{
        ...
        <div className={Styles.workHistory}>
              ...
              <div className={Styles.workHistoryContainer}>
                ...
                <button className={Styles.addWorkButton} onClick={() => setIsEditing(true)}> Add Education</button>
              </div>
            </div>

            {if(userProfile != authState.user && 
              return(
                <div onClick={()=>{
                updateProfileData()
              }} className={Styles.connectButton}>Update Profile</div>
          ...
          <div onClick={() => {
            ...
            <div onClick={(e) => {
              ...
              <input onChange={handleEducationInputChange} name="school"  type="text" className={Styles.inputField} placeholder='Enter School' />
              <input onChange={handleEducationInputChange} name="degree" type="text" className={Styles.inputField} placeholder='Enter Degree' />
              <input onChange={handleEducationInputChange} name="fieldOfStudy" type="text" className={Styles.inputField} placeholder='Enter Field of Study' />
              <div onClick={()=>{
                setUserProfile({...userProfile, education: [...userProfile.education, inputData]})
                setIsEditing(false)
              }} className={Styles.connectButton} >Add Education </div>
            </div>
          </div>
        }
      </DashboardLayout>
