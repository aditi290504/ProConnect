        ...
        )}
        {
          ...
          <div onClick={() => {
            ...
            <div onClick={(e) => {
              ...
              <input onChange={(e) => setPassword(e.target.value)} type="password" className={Styles.inputField} placeholder='Company' />
              <input onChange={(e) => setPassword(e.target.value)} type="password" className={Styles.inputField} placeholder='position' />
              <input onChange={(e) => setPassword(e.target.value)} type="password" className={Styles.inputField} placeholder='years' />
            </div>
          </div>
        }
      </DashboardLayout>
