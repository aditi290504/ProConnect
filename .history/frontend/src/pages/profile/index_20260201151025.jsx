        ...
        )}
        {
          ...
          <div onClick={() => {
            ...
            <div onClick={(e) => {
              ...
              <input onChange={handleWorkInputChange} type="text" className={Styles.inputField} placeholder='Enter position' />
              <input onChange={handleWorkInputChange} type="number" className={Styles.inputField} placeholder='years' />
