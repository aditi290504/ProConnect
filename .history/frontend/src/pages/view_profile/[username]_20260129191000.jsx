            ...
            <div style={{display: "flex", gap: "0.7rem"}}>
              <div style={{flex: "0.8"}}>
                ...
                {isCurrentUserInConnection ? 
                  ...
                  :
                  <button onClick={() => {
                    dispatch(sendConnectionRequest({token: localStorage.getItem("token"), user_id}))
                      ...
                      <div key={post._id} className={Styles.postCard}>
                        <div className={Styles.card}>
                          <div className={Styles.card_profileContainer}>
                            {post.media !== "" ? <img src={`${baseURL}/${post.media}`} alt="post media" /> : <div className={Styles.noImagePlaceholder}>No Image</div>}
                          </div>
                        </div>
                      </div>
                    )
